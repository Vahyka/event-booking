...
export const events: Event[] = [
  {
    ...
    description: 'Симфония Бетховена: Грандиозный цикл из всех девяти симфоний Людвига ван Бетховена в исполнении Большого симфонического оркестра под управлением маэстро Валерия Гергиева. Уникальная возможность за один вечер погрузиться в эволюцию гения — от героического пафоса Третьей «Героической» симфонии до бессмертной «Оды к радости» из Девятой, ставшей гимном общечеловеческих идеалов. Особое внимание — редкому исполнению Четвертой симфонии с её изысканными лирическими пассажами и Шестой («Пасторальной»), передающей гармонию природы. Концерт дополнен мультимедийной инсталляцией с проекцией рукописных партитур композитора.',
